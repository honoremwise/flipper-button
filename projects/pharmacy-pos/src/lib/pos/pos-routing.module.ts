...
const posRoutes: Routes = [
  {
    ...
    {
    path: 'till-orders',
    loadChildren: ()=> import('./../importables/orders/orders.module').then(m=>m.OrdersModule),
    canActivate: [AuthGuard]
    },
    {
      path: 'till-customers',
      loadChildren: ()=> import('./../importables/customers/customers.module').then(m=>m.CustomersModule),
      canActivate: [AuthGuard]
    },
    {
      path: 'till-pay',
      loadChildren: ()=> import('./../importables/pay/pay.module').then(m=>m.PayModule),
      canActivate: [AuthGuard]
    }
